...
### Unused-key check (`check-i18n.js`)

A second, complementary checker lives at the repo root: it scans
`messages.properties` and reports keys that aren't referenced anywhere in templates,
